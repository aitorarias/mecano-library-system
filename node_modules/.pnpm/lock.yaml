...
packages:
  ...
  /@jest/core@29.5.0:
    ...
    dependencies:
      ...
      jest-config: 29.5.0(@types/node@16.18.23)
  ...
  /@storybook/react@7.0.2(react-dom@18.2.0)(react@18.2.0):
  ...
  /jest-dom@4.0.0:
    resolution: {integrity: sha512-gBxYZlZB1Jgvf2gP2pRfjjUWF8woGBHj/g5rAQgFPB/0K2atGuhVcPO+BItyjWeKg9zM+dokgcMOH01vrWVMFA==}
